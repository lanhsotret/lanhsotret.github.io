...
$(window).on('load', function () {
    ...
    let showBar = (function(){
        ...
        $('#NavHeader-Svg svg path').eq(1).clone().insertBefore('#NavHeader-Svg svg path:last-child');
        $('#NavHeader-Svg svg path').first().remove();
        $('#NavHeader-Svg svg path').last().remove();
        $('#NavHeader-Svg svg path').first().css({'transform': 'translateY(-2.5rem) rotate(0deg)'});
        $('#NavHeader-Svg svg path').last().css({'transform': 'translateY(2.5rem) rotate(0deg)'});
        $('#NavHeader-Svg').click(function(){
            if($('#NavHeader-Svg svg path').css('fill') === checkColor) {
                ...
                $('#NavHeader-Svg svg path').first().css('transform', 'translateY(-2.5rem) rotate(0deg)');
                $('#NavHeader-Svg svg path').last().css('transform', 'translateY(2.5rem) rotate(0deg)');
                $('#NavHeader-Svg svg path').eq(1).css('transform', 'scale(1)');
